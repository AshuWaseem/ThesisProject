...
[x,fval,exitflag,output] = patternsearch(ObjectiveFunction,x0,[],[],[],[],lb,ub,nonlcon);
  mkdir (num2str(i));
    
    movefile ('allExecutions_PS_1.txt',num2str(i),'f');
...
res=1-avgaccuracy;
fileID = fopen('allExecutions_PS_1.txt','a');
tw2=num2str(x0);
tw2=strcat(tw2,'= ');
