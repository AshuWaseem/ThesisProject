...
options=optimoptions('ga','PopulationSize',10,'MaxGenerations',100);
...
for i=2:40
    ...
    movefile ('allExecutions_GA_2.txt',num2str(i),'f');
    [x,fval,EXITFLAG,OUTPUT] = ga(ObjectiveFunction,6,[],[],[],[],lb,ub,nonlcon,[],options);
end
...
res=1-avgaccuracy;
fileID = fopen('allExecutions_GA_2.txt','a');
tw2=num2str(x0);
tw2=strcat(tw2,'= ');
