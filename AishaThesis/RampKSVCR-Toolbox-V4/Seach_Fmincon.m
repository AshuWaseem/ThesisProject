...
movefile ('allExecutions_fmincon_2.txt',num2str(i),'f');
[x,fval,exitflag,output,lambda,grad,hessian]  = fmincon(ObjectiveFunction,x0,[],[],[],[],lb,ub);
end
...
res=1-avgaccuracy;
fileID = fopen('allExecutions_fmincon_2.txt','a');
tw2=num2str(x0);
tw2=strcat(tw2,'= ');
